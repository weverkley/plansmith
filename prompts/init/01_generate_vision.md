...
4.  Generate a list of 3-5 high-level **Epics** (the main features). The epics should be ordered in a logical sequence, from foundational features to user-facing features.
