...
5.  For each task, add relevant labels (e.g., 'frontend', 'backend', 'database', 'testing').
6.  You MUST respond ONLY with a single, valid JSON object containing *only the new items*.
